...
export class SelectionHandler {
  ...
  public dispose(): void {
    ...
    this.layer.findOne((node: Konva.Node) => node.hasName(this.selectionRectangle.name()))?.remove();
    this.layer.findOne((node: Konva.Node) => node.hasName(this.transformer.name()))?.remove;
